...
const translations = {
  en: {
    ...
    welcome: "Welcome",
    vendorHeroDesc: "Manage your listings, track bookings, and grow your rental business seamlessly.",
    custHeroDesc: "Discover high-quality equipment, vehicles, and spaces for rent nearby.",
  ...
  kn: {
    ...
    welcome: "ಸುಸ್ವಾಗತ",
    vendorHeroDesc: "ನಿಮ್ಮ ಸೇವೆಗಳನ್ನು ನಿರ್ವಹಿಸಿ, ಬುಕಿಂಗ್ ಟ್ರ್ಯಾಕ್ ಮಾಡಿ ಮತ್ತು ವ್ಯವಹಾರವನ್ನು ಸುಲಭವಾಗಿ ಬೆಳೆಸಿ.",
    custHeroDesc: "ಬಾಡಿಗೆಗೆ ಗುಣಮಟ್ಟದ ಉಪಕರಣಗಳು, ವಾಹನಗಳು ಮತ್ತು ಸ್ಥಳಗಳನ್ನು ಹತ್ತಿರದಲ್ಲಿ ಹುಡುಕಿ.",
